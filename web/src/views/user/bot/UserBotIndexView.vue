      ...
      <div class="col-9">
        <div class="card" style="margin-top: 20px">
          <div class="card-header">
            <span style="font-size: 100%">我的Bot</span>
...
export default {
  ...
  setup() {
    ...
    const refresh_bots = () => {
      $.ajax({
        url: "http://192.168.1.2:3000/user/bot/getlist/",
        type: "get",
        headers:{
    ...
    const add_bot = () => {
      ...
      $.ajax({
        url:"http://192.168.1.2:3000/user/bot/add/",
        type:"post",
        data:{
          title:botadd.title,
        ...
        success(resp){
          if (botadd.error_message === "success"){
            botadd.title = "";
            botadd.description = "";
            botadd.content = "";
    ...
    const update_bot = (bot) => {
      botadd.error_message = "";
      $.ajax({
        url:"http://192.168.1.2:3000/user/bot/update/",
        type:"post",
        data:{
          bot_id:bot.id,
          title:bot.title,
    ...
    const remove_bot = (bot) => {
      $.ajax({
        url: "http://192.168.1.2:3000/user/bot/remove/",
        type: "post",
        data: {
          bot_id:bot.id,
        },
